#!/usr/bin/python3
"""Rectangle that defines a rectangle by: (based on 8-rectangle.py)"""
...
class Rectangle:
    ...
    def square(cls, size=0):
        """Returns new rectangle with width, height and size all equal
        Args: size (int): height and width of the new rectangle"""
